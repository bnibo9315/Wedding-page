...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="acess/img/icon_x3s_icon.ico" />
...
<body>
	...
	<section class="intro">
		<div class="biglogo">
			...
			<h3 id="textbiglogo">sắp <span class="yellowhighlight">kết hôn</span></h3>
		</div>
		...
		<div class="w3-row-padding " id="wp1">
			...
			<div class="w3-col s12 m4 l4 text">
				<h3 class="content introduce" id="intro">
					...
					đầu nhìn cô ấy. Chàng trai ấy cứ mỗi ngày lại chọc tức cô ấy nổi giận, khiến cô ấy chú ý tới mình nhưng
					...
					<div class="w3-row-padding w3-padding-32">
						<div class="w3-col l6 m12" style=" text-align: left;">
							<div class="w3-padding-16">
								<input autocomplete="off" class="w3-input w3-border w3-animate-input" type="text" name="username" placeholder="Họ và tên của bạn nhé" required />
							</div>
							<div class="w3-padding-16 ">
								<input autocomplete="off" class="w3-input w3-border w3-animate-input" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" type="number" name="phone" placeholder="Số điện thoại nữa" required />
							</div>
						</div>
						<div class="w3-col l6 m12" style=" text-align: left;">
							<div class="w3-padding-16">
								<input autocomplete="off" class="w3-input w3-border  w3-animate-input" min="1" max="20" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" type="number" name="number" placeholder="Bạn đi bao nhiêu người nè" required />
							</div>
							<div class="w3-padding-16">
								<select class="w3-select w3-border w3-left-align" style="background: #fff; color:#666;" name="type_user" required>
									...
									<option value="cả hai">Bạn Chung</option>
								</select>
							</div>
						</div>
						<div class="w3-col w3-padding-16 w3-center">
							<input autocomplete="off" class="w3-input w3-border w3-animate-input" style="height:100px;" placeholder="Để lại tin nhắn cho bọn mình nhé " name="messeger" />
						</div>
						<div class="w3-col w3-padding-16">
							<div class="w3-center">
								<button data-toggle="modal" data-target="" type="submit" name="submit" class="button" style="border:none" id="submit">Liên hệ với chúng tớ nhé 💕</button>
							</div>
						</div>
					</div>
				</form>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Hãy chụp lại mã QRCode hoặc tải về để checkin nhé 💕</h4>
			</div>
			<div class="modal-body center-img">
				<img src="" id="QRImg" alt="">
			</div>
			<div class="modal-footer">
				<button id="saveImg" onclick="" type="button" class="btn btn-success" data-dismiss="modal">Tải ảnh về nhé</button>
...
<div class="modal fade" id="Notifal" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Hãy thử lại sau nhé 💕</h4>
			</div>
...
<footer>
	<div style="height: 50px;text-align: center;" class="">
		<a href="#story">
			<i class="fas  fa-chevron-up fa-2x up_arrow"></i>
		</a>
	</div>
	<div class="footer">
...
<script>
	...
	$(document).ready(function() {
		...
		$('#SData').submit(function(e) {
			...
			var form = $(this);
			var actionUrl = '../php/sentdata.php';
			$.ajax({
				type: "POST",
				url: actionUrl,
				data: form.serialize(),
		...
		function saveImg(source) {
			...
			el.setAttribute("download", "checkin.png");
